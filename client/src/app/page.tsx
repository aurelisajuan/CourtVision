      ...
      <header className="border-b">
        <div className="container flex items-center justify-between py-4">
          ...
          <div className="flex items-center gap-4">
            <Button variant="outline" className="hidden md:flex bg-white text-blue-600 border-blue-600">
              Sign In
            </Button>
      ...
      <main className="flex-1">
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Transform 2D sports footage into immersive, interactive 3D experiences. Walk around plays, analyze
                  calls, and get AI-powered insights in real-time.
                </p>
                ...
                <div className="flex items-center gap-4 text-sm text-gray-500">
                  ...
                  <div className="flex items-center gap-1">
                    <span className="text-xs px-2 py-1 bg-gray-100 rounded-full">Video Gaussians</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="text-xs px-2 py-1 bg-gray-100 rounded-full">Retell AI</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="text-xs px-2 py-1 bg-gray-100 rounded-full">OpenAI</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="text-xs px-2 py-1 bg-gray-100 rounded-full">ElevenLabs</span>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 bg-white" id="problem">
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                <div className="inline-block rounded-lg bg-blue-100 px-3 py-1 text-sm text-blue-600">The Problem</div>
                ...
                <p className="text-gray-500 md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed">
                  Every season, thousands of controversial basketball calls go viral. Was that a charge or a block? Did
                  he actually get fouled, or was it a dive?
                </p>
                <ul className="space-y-2 text-gray-500">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>Helping players visualize spacing, rotation, and timing</span>
                  </li>
                </ul>
                <p className="text-gray-500">
                  This lack of perspective creates frustration and inefficiencies for teams at all levels—from high
                  school to pro.
                </p>
              </div>
        ...
        <section className="py-16 bg-blue-50" id="solution">
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              ...
              <div className="space-y-4">
                <div className="inline-block rounded-lg bg-blue-100 px-3 py-1 text-sm text-blue-600">The Solution</div>
                <h2 className="text-3xl font-bold tracking-tighter">
                  CourtVision VR transforms 2D footage into immersive 3D experiences
                </h2>
                <p className="text-gray-500 md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed">
                  Using Video Gaussians, coaches and analysts can slow down plays, walk around them in VR, and ask a
                  voice AI to analyze what's happening—frame by frame, call by call.
                </p>
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="rounded-lg border bg-white p-4 shadow-sm">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Move around plays in VR, like standing on the court mid-replay.
                    </p>
                  </div>
                  <div className="rounded-lg border bg-white p-4 shadow-sm">
                    <div className="flex items-center gap-2">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Voice assistant answers questions and explains tactical breakdowns.
                    </p>
                  </div>
                  <div className="rounded-lg border bg-white p-4 shadow-sm">
                    <div className="flex items-center gap-2">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      AI detects whether contact was real, accidental, or exaggerated.
                    </p>
                  </div>
                  <div className="rounded-lg border bg-white p-4 shadow-sm">
                    <div className="flex items-center gap-2">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      AI narrates analysis with emotion, making breakdowns engaging.
                    </p>
                  </div>
                </div>
                <div className="flex flex-wrap gap-4">
                  <Link href="/demo">
                    <Button className="bg-blue-600 hover:bg-blue-700">Try the Demo</Button>
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  CourtVision VR combines cutting-edge technologies to deliver an unparalleled sports analysis
                  experience.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
              <div className="grid gap-6">
                <div className="rounded-lg border bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    Video Gaussians convert footage into dynamic 3D spatial scenes with camera motion, allowing you to
                    view plays from any angle.
                  </p>
                </div>
                <div className="rounded-lg border bg-white p-6 shadow-sm">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    Retell AI enables live back-and-forth voice conversations during replays, answering questions about
                    rules, tactics, and player positioning.
                  </p>
                </div>
                <div className="rounded-lg border bg-white p-6 shadow-sm">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    OpenAI GPT-4o detects events (screens, flops, fouls) and understands visual context to provide
                    accurate analysis of game situations.
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-blue-100 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Experience the future of sports analysis with CourtVision VR. Try our interactive demo today.
                </p>
              </div>
              <div className="flex flex-wrap items-center justify-center gap-4">
                <Link href="/demo">
                  <Button className="bg-white text-blue-600 hover:bg-blue-50">Try the Demo</Button>
                </Link>
                <Link href="#contact">
      ...
      <footer className="border-t bg-gray-50">
        <div className="container flex flex-col gap-4 py-10 md:flex-row md:gap-8">
          <div className="flex-1 space-y-4">
            ...
            <p className="text-sm text-gray-500">
              Transform 2D sports footage into immersive, interactive 3D experiences for coaches, analysts, and
              referees.
            </p>
          </div>
        ...
        <div className="border-t bg-gray-100 py-6">
          <div className="container flex flex-col items-center justify-between gap-4 md:flex-row">
            <p className="text-xs text-gray-500">© 2025 CourtVision VR. All rights reserved.</p>
